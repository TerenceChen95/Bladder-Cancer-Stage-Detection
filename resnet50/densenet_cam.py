...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-path', type=str, default='/home/tianshu/bladder-cancer/dataset/bbox_images/TCGA-ZF-AA5P40_bbox.jpg',
                        help='input image path')
    parser.add_argument('--weight-path', type=str, default='BEST_checkpoint_resnet50.pth.tar',
