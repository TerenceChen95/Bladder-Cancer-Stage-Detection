...
if __name__ == '__main__':
  ...
  pascal_classes = np.asarray(['__background__', 'bladder'])
  ...
  while (num_images >= 0):
      ...
      # Load the demo image
        ...
        #read dicom files
        #im_in = pydicom.read_file(im_file).pixel_array
      ...
      if vis and webcam_num == -1:
          ...
          im_out = scipy.misc.toimage(im2show)
          im_out.save(result_path)
      else:
